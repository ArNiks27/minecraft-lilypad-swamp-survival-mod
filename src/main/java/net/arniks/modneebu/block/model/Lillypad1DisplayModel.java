...
public class Lillypad1DisplayModel extends GeoModel<Lillypad1DisplayItem> {
	@Override
	public ResourceLocation getAnimationResource(Lillypad1DisplayItem animatable) {
		return new ResourceLocation("mod_ne_ebu", "animations/lilly_pad_1.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(Lillypad1DisplayItem animatable) {
		return new ResourceLocation("mod_ne_ebu", "geo/lilly_pad_1.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(Lillypad1DisplayItem entity) {
