...
import net.arniks.modneebu.block.Lillypad1Block;

import javax.annotation.Nullable;

import java.util.stream.IntStream;

public class Lillypad1TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Lillypad1TileEntity(BlockPos pos, BlockState state) {
		super(ModNeEbuModBlockEntities.LILLYPAD_1.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Lillypad1Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Lillypad1TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Lillypad1TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("lillypad_1");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Lillypad 1");
	}
