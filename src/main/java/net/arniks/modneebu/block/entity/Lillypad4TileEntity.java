...
public class Lillypad4TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Lillypad4TileEntity(BlockPos pos, BlockState state) {
		super(ModNeEbuModBlockEntities.LILLYPAD_4.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Lillypad4Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Lillypad4TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Lillypad4TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	@Override
	...
	public Component getDefaultName() {
		return Component.literal("lillypad_4");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Lillypad 4");
	}
