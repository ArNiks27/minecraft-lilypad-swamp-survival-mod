...
import net.arniks.modneebu.block.Lillypad3Block;

import javax.annotation.Nullable;

import java.util.stream.IntStream;

public class Lillypad3TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Lillypad3TileEntity(BlockPos pos, BlockState state) {
		super(ModNeEbuModBlockEntities.LILLYPAD_3.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Lillypad3Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Lillypad3TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Lillypad3TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	@Override
	...
	public Component getDefaultName() {
		return Component.literal("lillypad_3");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Lillypad 3");
	}
