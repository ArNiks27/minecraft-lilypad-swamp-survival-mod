...
import net.arniks.modneebu.block.LillyPad2Block;

import javax.annotation.Nullable;

import java.util.stream.IntStream;

public class LillyPad2TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LillyPad2TileEntity(BlockPos pos, BlockState state) {
		super(ModNeEbuModBlockEntities.LILLY_PAD_2.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(LillyPad2Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LillyPad2TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LillyPad2TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	@Override
	...
	public Component getDefaultName() {
		return Component.literal("lilly_pad_2");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Lilly Pad 2");
	}
