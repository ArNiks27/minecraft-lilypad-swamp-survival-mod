...
public class Lillypad5TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Lillypad5TileEntity(BlockPos pos, BlockState state) {
		super(ModNeEbuModBlockEntities.LILLYPAD_5.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Lillypad5Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Lillypad5TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Lillypad5TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	@Override
	...
	public Component getDefaultName() {
		return Component.literal("lillypad_5");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Lillypad 5");
	}
